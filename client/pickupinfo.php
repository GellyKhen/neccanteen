    ...
    <div id="demo-1" style="height: 12px" data-zs-src='["images/g1.jpg","images/g2.jpg","images/g3.jpg","images/g4.jpg","images/g5.jpg"]' data-zs-overlay="dots">
        <div class="demo-inner-content" >
            ...
            <div class="baner-info">
              <center>
                <h4>          
                <img src="images/pickuplogo.png" style="height: 152px;width: 152px;" alt="" />
               </h4>
                <h4> Pick - Up </h4>
            </center>
            </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class='col-md-4'>
                  Date of Pick-Up: *<input type="date" name="orderDate" class="form-control" 
       min="<?php date_default_timezone_set('Asia/Manila');
                  $dateToday=date("Y-m-d"); echo $dateToday; ?>" max="2091-12-31" required="true">  
          </div>

          <div class='col-md-4'>
                  Time of Pick-Up: *<input type="time" name="orderTime" class="form-control" required="true" maxlength="129">  
          </div>
