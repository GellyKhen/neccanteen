...
$archivingquery2 = "INSERT INTO `tbl_fooditemarchive` SELECT * FROM `tbl_fooditem` WHERE `fooditemID` = '$id'";
$deletingquery2 = "DELETE FROM `tbl_fooditem` WHERE `tbl_fooditem`.`fooditemID` = '$id'";
	...
	// echo "<script type='text/javascript'>alert('$message');</script>";	
		...
		if (mysqli_query($connect, $archivingquery2))
		{
			...
			else
			{
				...
				echo "<script type='text/javascript'>alert('$message');</script>";
				echo "<script type='text/javascript'>location.href = 'NecFooItems.php';</script>";
			}
		}
		else
		{
